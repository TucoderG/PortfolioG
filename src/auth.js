...
const registerForm = async (req, res) =>{
    ...
    try{
        ...
        var message = {
            ...
            html: `<p>Link para la validacion: <br> <a href='https://tucoderg.onrender.com/confirmarCuenta/${user.tokenConfirm}'>Ingrese aquí</a></p>`
        };
...
const recovPass = async (req, res) =>{
    ...
    try{
        ...
        var message = {
            ...
            html: `<p>Link para cambiar su contraseña: <br> <a href='https://tucoderg.onrender.com/recover/${user.tokenConfirm}'>Ingrese aquí</a></p>`
        };
        var transporter = nodemailer.createTransport({
            service: 'gmail',
            host: 'smtp.gmail.com',
